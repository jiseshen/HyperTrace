...
class TracerConfig:
    ...
    inference_retrieval_query_mode: str = "current"
    inference_retrieve_top_k: int = 12
    inference_retrieve_pool_k: int = 30
    inference_filter_pool_k: int = 20
    inference_content_max_k: int = 4
    inference_style_max_k: int = 3
    inference_min_prior: float = 0.1
    inference_model_filter: bool = False
    inference_empty_profile_on_no_relevance: bool = False
    prediction_profile_source: str = "inference"
    prediction_retrieve_top_k: int = 12
    prediction_retrieve_pool_k: int = 30
    prediction_min_prior: float = 0.1
